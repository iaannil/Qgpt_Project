...
useEffect(()=>{
  ...
  return (
    ...
    <div ref={containerRef} className="flex-1 mb-5 overflow-y-scroll">
        {messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center gap-2 text-primary">
            ...
            <p className="mt-5 text-4xl sm:text-6xl text-center text-gray-400 dark:text-white">Ask me Something</p>
          </div>
        )}
    ...
    {/* prompt input box */}
    <form onSubmit={onSubmit} action=" " className=" bg-primary/20 dark:bg-[#583C79]/30 border border-primary dark:border-[#80609F]/30 rounded-full w-full mac-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center">
